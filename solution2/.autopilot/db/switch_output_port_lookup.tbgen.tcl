set C_TypeInfoList {{ 
"switch_output_port_lookup" : [[], { "return": [[], "void"]} , [{"ExternC" : 0}], [ {"s_axis_tdata": [[],"0"] }, {"s_axis_tkeep": [[],"1"] }, {"s_axis_tuser": [[],"2"] }, {"s_axis_tvalid": [[],"3"] }, {"s_axis_tready": [[], {"reference": "3"}] }, {"s_axis_tlast": [[],"3"] }, {"m_axis_tdata": [[], {"reference": "0"}] }, {"m_axis_tkeep": [[], {"reference": "1"}] }, {"m_axis_tuser": [[], {"reference": "2"}] }, {"m_axis_tvalid": [[], {"reference": "3"}] }, {"m_axis_tready": [[],"3"] }, {"m_axis_tlast": [[], {"reference": "3"}] }, {"reset": [[],"3"] }],[],""], 
"2": [ "ap_uint<128>", {"hls_type": {"ap_uint": [[[[], {"scalar": { "int": 128}}]],""]}}], 
"1": [ "ap_uint<32>", {"hls_type": {"ap_uint": [[[[], {"scalar": { "int": 32}}]],""]}}], 
"3": [ "ap_uint<1>", {"hls_type": {"ap_uint": [[[[], {"scalar": { "int": 1}}]],""]}}], 
"0": [ "ap_uint<256>", {"hls_type": {"ap_uint": [[[[], {"scalar": { "int": 256}}]],""]}}]
}}
...
set portList { 
	...
	{ s_axis_tdata_V sc_in sc_lv 256 signal 0 } 
	{ s_axis_tkeep_V sc_in sc_lv 32 signal 1 } 
	{ s_axis_tuser_V sc_in sc_lv 128 signal 2 } 
	{ s_axis_tvalid_V sc_in sc_lv 1 signal 3 } 
	{ s_axis_tready_V sc_out sc_lv 1 signal 4 } 
	{ s_axis_tlast_V sc_in sc_lv 1 signal 5 } 
	{ m_axis_tdata_V sc_out sc_lv 256 signal 6 } 
	{ m_axis_tkeep_V sc_out sc_lv 32 signal 7 } 
	{ m_axis_tuser_V sc_out sc_lv 128 signal 8 } 
	{ m_axis_tvalid_V sc_out sc_lv 1 signal 9 } 
	{ m_axis_tready_V sc_in sc_lv 1 signal 10 } 
	{ m_axis_tlast_V sc_out sc_lv 1 signal 11 } 
	{ reset_V sc_in sc_lv 1 signal 12 } 
}
set NewPortList {[ 
