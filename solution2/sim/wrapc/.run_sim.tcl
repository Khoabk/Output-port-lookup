...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "switch_output_port_lookup.autotvin.dat"
	set constFileTvOut       "switch_output_port_lookup.autotvout.dat"
	set constFileHdlTvIn     "switch_output_port_lookup.autohdltvin.dat"
	set constFileHdlTvOut    "switch_output_port_lookup.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
