...
#pragma HLS ARRAY_PARTITION variable = lut.table dim =1 complete   //This pragma is used so the array is partitioned into individual registers 
	...
	for(int i=0; i<16; i++)
	{
		#pragma HLS UNROLL    //This pragma is used so 16 entries will be processed in parallel
	...
	if(!lut_learn_hit){ 
		...
		//Learn new src_mac and src_port if not in the table
