...
if {[file isfile switch_output_port_lookup.autotvin.dat]} {
	file delete -force switch_output_port_lookup.autotvin.dat
}

if {[file isfile switch_output_port_lookup.autotvout.dat]} {
	file delete -force switch_output_port_lookup.autotvout.dat
}
